...
const SignUp = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const isUsernameUnique = !users.some((existingUser) => existingUser.name === user.name);
    const isEmailUnique = !users.some((existingUser) => existingUser.email === user.email);

    if (validateInput() && isUsernameUnique && isEmailUnique) {
