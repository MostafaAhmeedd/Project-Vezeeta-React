            ...
            <Swiper className="Oswiper"
                ...
                <SwiperSlide className="Oswiper-slider">
                    <div className="Ocard-style">
                        ...
                        <img className="Oimg" src="/OffersImages/teethCleaning.jpeg"></img>
                ...
                <SwiperSlide className="Oswiper-slider">
                    <div className="Ocard-style">
                        ...
                        <img className="Oimg" src="/OffersImages/facialCleansing.jpeg"></img>
                ...
                <SwiperSlide className="Oswiper-slider">
                    <div className="Ocard-style">
                        ...
                        <img className="Oimg" src="/OffersImages/visionCorrection.jpeg"></img>
                        <div className="Ooffer-info">
                ...
                <SwiperSlide className="Oswiper-slider">
                    <div className="Ocard-style">
                        ...
                        <img className="Oimg" src="./OffersImages/metalBraces.jpeg"></img>
                        <div class="Ooffer-info">
                ...
                <SwiperSlide className="Oswiper-slider">
                    <div className="Ocard-style">
                        ...
                        <img className="Oimg" src="/OffersImages/facePeeling.jpeg"></img>
                        <div class="Ooffer-info">
                ...
                <SwiperSlide className="Oswiper-slider">
                    <div className="Ocard-style">
                        ...
                        <img className="Oimg" src="/OffersImages/weightLoss.jpeg"></img>
                ...
                <SwiperSlide className="Oswiper-slider">
                    <div className="Ocard-style">
                        ...
                        <img className="Oimg" src="./OffersImages/vitaminD.jpeg"></img>
                        <div className="Ooffer-info">
                ...
                <SwiperSlide className="Oswiper-slider">
                    <div className="Ocard-style">
                        ...
                        <img className="Oimg" src="/OffersImages/laserHairRemoval.jpeg"></img>
                        <div className="Ooffer-info">
